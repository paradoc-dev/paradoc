<p align="center">
  <a href="https://paradoc.dev?utm_source=github&utm_medium=eslint_config" target="_blank" rel="noopener noreferrer">
    <picture>
...
<h1 align="center">@paradoc/eslint-config</h1>

<div align="center">

[![Paradoc documentation](https://img.shields.io/badge/Documentation-Paradoc-red.svg)](https://docs.paradoc.dev?utm_source=github&utm_medium=eslint_config)
...
```json
{
  "extends": ["@paradoc/eslint-config"]
}
```

## Changelog

View the [Changelog](https://github.com/paradoc-dev/paradoc/blob/main/packages/eslint-config/CHANGELOG.md) for updates.

## Related packages

- [`@paradoc/sdk`](../sdk) - Paradoc framework SDK
- [`@paradoc/typescript-config`](../typescript-config) - Shared TypeScript configuration
