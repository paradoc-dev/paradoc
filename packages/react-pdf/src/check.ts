 ...
 * `CheckModeProvider`
 * (`@paradoc/react`), which `Document`'s context reads: with
...
import type { ReactLayerComponent } from "./layer";
import { preparePdfTree } from "./tree";
import type { PdfAdapterName } from "./adapter";
