 ...
 *
 * `src/tailwind.ts` claims the engine honours every family it admits. This
...
import { PDF_RESET_STYLESHEET } from "../src/reset";
import {
 ...
 * the module doc in `src/tailwind.ts`). A property that acts on the text
