      ...
      item: {
        ...
        fields: {
          ...
          amount: {
            ...
            label: "Amount",
            description:
              "The row multiplied out. Derived rather than answered: a filler supplies the quantity and the unit price, and `computeLineAmounts` does the arithmetic. Requiring it would make a session ask a vendor to multiply.",
            min: 0,
            required: false,
            visible: false,
          },
