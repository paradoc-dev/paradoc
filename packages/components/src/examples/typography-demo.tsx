...
/**
 * The `/components/typography` docs page's Preview: the token unset, which is
 * `regular`, on two titled sections, a table with its header, and the totals.
 */
...
export function TypographyDemo() {
  return (
    <Document artifact={proposalForm} data={shortProposalData} id="typography-demo">
