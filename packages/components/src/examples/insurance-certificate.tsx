 ...
 * Text and field components own their typography.
 */
    ...
    <>
      ...
      <Section id="masthead" className="flex flex-row justify-between gap-8 border-b border-neutral-800 pb-4">
        <div className="flex basis-1/2 flex-col gap-1">
          ...
          <Field path="insurer" label={false} className="text-neutral-700" />
        </div>
      ...
      <Section id="insured" title="Named insured" className="flex flex-col gap-1">
        <Field path="insured" label={false} className="font-medium text-neutral-900" />
        <Field path="insuredAddress" label={false} className="text-neutral-600" />
      </Section>

      <Section id="holder" title="Certificate holder" className="flex flex-col gap-1">
        <Field path="certificateHolder" label={false} className="font-medium text-neutral-900" />
      </Section>
      ...
      <Section id="remarks" title="Remarks">
        <Field path="remarks" label={false} className="text-neutral-800" />
      </Section>
    </>
  );
}
