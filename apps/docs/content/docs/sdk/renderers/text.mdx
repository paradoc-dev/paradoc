...
Render forms to HTML, Markdown, or plain text with Paradoc's deterministic
template syntax. It supports interpolation, nested paths, conditionals, loops,
context blocks, and helpers without executing arbitrary JavaScript. Field
values are automatically formatted from their schema types.
...
The text renderer includes helpers for rendering signature and initials markers in templates.
