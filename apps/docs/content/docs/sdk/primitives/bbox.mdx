...
const area = p.bbox.parse(jsonData)

// Safe parsing (returns result object)
const result = p.bbox.safeParse(jsonData)
if (result.success) {
...
- [Bbox Field](/sdk/artifacts/form/field#spatial) - Bbox field type
