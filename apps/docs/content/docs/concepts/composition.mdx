...
Bundle contents can be **inline**, **path-referenced**, or **registry-referenced**.
...
This applies to layers and bundle contents. Reuse fields by spreading typed field objects, as above; fields and annexes are not path references.
