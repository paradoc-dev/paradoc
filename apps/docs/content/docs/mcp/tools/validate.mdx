---
title: validate
description: Validate a Paradoc artifact against the schema and logic rules
ogTitle: validate — Paradoc MCP
ogDescription: Validate a Paradoc artifact against the schema and logic rules using the MCP server
---

Validates a Paradoc artifact (form, document, bundle, or checklist) against the Paradoc schema and optionally checks logic expressions.
