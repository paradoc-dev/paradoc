...
| **Topic** | `artifacts`, `fields`, `parties`, `annexes`, `logic`, `layers`, `rendering`, `formatting`, `instructions`, `pdf-bindings` | Canonical concept knowledge — surface-agnostic |
...
<Tabs items={['Claude Code', 'Claude.ai', 'Other agents']} groupId="skill-client" persist>
  <Tab value="Claude Code">
    ...
    Once installed, the skill activates automatically when Claude Code detects Paradoc-related work — `@paradoc/*` imports, the `paradoc` CLI, JSON/YAML artifacts, or `mcp.paradoc.dev`.
