...
description: The nine tools in the Paradoc AI packages, with their inputs and outputs
ogTitle: Tools — Paradoc AI
ogDescription: Reference for the nine tools in the Paradoc AI packages
---

Every Paradoc AI adapter ([AI SDK](/ai/ai-sdk), [TanStack AI](/ai/tanstack-ai), [Mastra](/ai/mastra)) exposes these nine tools. They come from [`@paradoc/ai-tools`](/ai/ai-tools), so names, inputs, and outputs are the same in every adapter. Input and output fields are snake_case. Artifact JSON and fill data keep their own field names.
