...
|----------|----------|-----------------|
| `@paradoc/render/text` | Text/Markdown/HTML layers | handlebars |
| `@paradoc/render/pdf` | PDF layers, `inspect` command | pdf-lib |
| `@paradoc/render/docx` | DOCX layers | docx-templates |
...
@paradoc/render/text       0.2.1      0.2.1     ok      245.3 KB
@paradoc/render/pdf        0.2.1      0.2.1     ok      1.2 MB
@paradoc/render/docx       not installed  0.2.1  -       -
```
