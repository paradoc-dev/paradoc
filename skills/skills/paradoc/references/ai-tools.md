...
`maxOutputBytes` (default `DEFAULT_MODEL_OUTPUT_MAX_BYTES`, 16,384) caps the `content` the model sees in every adapter. Your code still gets the full tool result. No subpaths.
